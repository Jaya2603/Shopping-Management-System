...
<?php
$id=$_GET['id'];
$rs=mysqli_query($con,"select * from invoice_service_detail where ivsd_id=$id");
...
if($_SERVER['REQUEST_METHOD']=="POST")
{
    ...
    $qut=$_POST['qut'];
    $rate=$_POST['rate'];
    //echo "update invoice_service_detail set I_ID='$iid',SALES_ID='$sid',QUANTITY='$qut',RATE='$rate' where IVSD_ID='$id' ";
    if(mysqli_query($con,"update invoice_service_detail set I_ID='$iid',SERVICE_ID='$sid',QUANTITY='$qut',RATE='$rate' where IVSD_ID='$id' "))
    {?>
...
<div class="content-wrapper">
  ...
  <div class="col-lg-9 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                  <h4 class="card-title text-primary">UPDATION IN INVOICE SERVICE DETAIL</h4>
